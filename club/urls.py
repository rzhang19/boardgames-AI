...
urlpatterns = [
    ...
    path('games/sub-collections/', views.sub_collection_list, name='sub_collection_list'),
    path('games/sub-collections/create/', views.sub_collection_create, name='sub_collection_create'),
    path('games/sub-collections/<int:pk>/edit/', views.sub_collection_edit, name='sub_collection_edit'),
    path('games/sub-collections/<int:pk>/delete/', views.sub_collection_delete, name='sub_collection_delete'),
    ...
    path('manage-users/<int:pk>/restore/', views.user_restore, name='user_restore'),
    path('manage-users/<int:pk>/permanent-delete/', views.user_permanent_delete, name='user_permanent_delete'),
    ...
    path('events/<int:pk>/extend/', views.event_extend, name='event_extend'),
    path('events/<int:pk>/end/', views.event_end_early, name='event_end_early'),
    path('events/<int:pk>/timer-status/', views.event_timer_status, name='event_timer_status'),
    path('events/<int:pk>/summary/', views.event_summary, name='event_summary'),
    path('games/<int:pk>/add-to-library/', views.game_add_to_library, name='game_add_to_library'),
    path('games/<int:pk>/add-to-library/save/', views.game_add_to_library_save, name='game_add_to_library_save'),
    path('game-proposal/<int:pk>/accept/', views.game_proposal_accept, name='game_proposal_accept'),
    path('game-proposal/<int:pk>/decline/', views.game_proposal_decline, name='game_proposal_decline'),
