...
urlpatterns = [
    ...
    path('events/add/recurring/', views.event_add_recurring, name='event_add_recurring'),
    path('events/add/recurring/preview/', views.event_add_recurring_preview, name='event_add_recurring_preview'),
