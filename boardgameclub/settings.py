...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'club.context_processors.site_lockdown_status',
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'club.validators.HasLetterAndDigitValidator',
    },
]
...
SEND_REAL_EMAILS = os.environ.get('SEND_REAL_EMAILS', 'False').lower() in ('true', '1', 'yes')
...
VIEW_ONLY_USERNAME = os.environ.get('VIEW_ONLY_USERNAME', '')
